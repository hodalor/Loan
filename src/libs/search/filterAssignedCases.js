const _filterAssignedCases = async (data) => {
  ...
  if (type === "Review Staff") {
    filteredData = dataToFilter.filter((item) => item.rvOfName === filter);
  }
...
export default _filterAssignedCases;
