...
export default function CreateUsers() {
  ...
  const openGroupModal = (group, enableEdit = false) => {
    setActiveTab("groups");
    setSelectedGroupId(group.id);
    setGroupModalOpen(true);
    setIsGroupEditing(enableEdit);
  };
  ...
  return (
    <div className="space-y-4">
      ...
      {groupModalOpen && selectedGroup ? (
        <div
          className="fixed inset-0 z-[1450] flex items-center justify-center bg-slate-900/55 p-4"
        ...
        >
          <div
            ...
            aria-modal="true"
          >
            <div className="sticky top-0 z-10 flex flex-col gap-4 rounded-t-[28px] border-b border-slate-200 bg-white px-6 py-5 sm:flex-row sm:items-start sm:justify-between">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.22em] text-blue-600">
                  Group Details
                </p>
                <h4 className="text-xl font-semibold text-slate-900">{selectedGroup.name}</h4>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  type="button"
                  className="inline-flex min-w-[92px] items-center justify-center rounded-2xl border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-50"
                  onClick={closeGroupModal}
                >
                  Close
                </button>
              ...
              <div className="grid gap-4 lg:grid-cols-[320px_minmax(0,1fr)]">
                ...
                <div className="rounded-3xl border border-slate-200 bg-slate-50 p-4">
                  <div className="mb-3 flex items-center justify-between">
                    <div>
                      <h5 className="text-sm font-semibold text-slate-900">Department Staff</h5>
                      <p className="text-xs text-slate-500">
