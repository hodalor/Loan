...
class MobileEnv {
  ...
  static String get appName => dotenv.maybeGet('APP_NAME') ?? 'SpeedCash';

  static String? get apiBaseUrl => dotenv.maybeGet('API_BASE_URL');
  static String? get customerAuthBaseUrl =>
      dotenv.maybeGet('CUSTOMER_AUTH_BASE_URL');
  static String? get lanApiBaseUrl => dotenv.maybeGet('LAN_API_BASE_URL');
  static String? get lanCustomerAuthBaseUrl =>
      dotenv.maybeGet('LAN_CUSTOMER_AUTH_BASE_URL');
  static String? get hostedApiBaseUrl => dotenv.maybeGet('HOSTED_API_BASE_URL');
  static String? get hostedCustomerAuthBaseUrl =>
      dotenv.maybeGet('HOSTED_CUSTOMER_AUTH_BASE_URL');
